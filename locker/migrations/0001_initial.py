    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locker_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='locker_Locker_sets', to='locker.lockerset')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='locker_log_Users', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
