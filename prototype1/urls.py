...
from inventory.views import handler404, MainPage, borrow_list_view, remove_from_borrow_list, get_qr_code, todays_requests_view
...
urlpatterns = [
    ...
    path('todays-requests/', todays_requests_view, name='todays_requests'),
]
